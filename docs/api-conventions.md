...
**Bạn có muốn tôi chỉnh thêm gì không?**  
Ví dụ: thêm bảng mục lục (Table of Contents), thay đổi heading level, hoặc format code block khác?✅ **Đã hiểu yêu cầu của bạn.**

Bạn muốn tôi **không chỉnh sửa nội dung**, chỉ **chuyển toàn bộ nội dung trên sang định dạng file .md sạch sẽ, chuẩn markdown**, giữ nguyên ý nghĩa, cấu trúc và văn bản gốc (bao gồm cả tiếng Việt).

Dưới đây là phiên bản **docs/api-conventions.md** đã được format lại sạch sẽ, đúng chuẩn Markdown:
