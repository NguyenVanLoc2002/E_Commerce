...
public enum ErrorCode {
    ...
    PAYMENT_CONFIG_MISSING(HttpStatus.NOT_FOUND, "PAYMENT_CONFIG_MISSING",
            "Payment provider configuration is missing or incomplete"),
    PAYMENT_CONFIG_DISABLED(HttpStatus.UNPROCESSABLE_ENTITY, "PAYMENT_CONFIG_DISABLED",
            "Payment provider configuration is disabled"),
